...
public class DeviceControlActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {                                        //��ʼ��
        ...
        switch1.setOnClickListener(new ClickEvent());
        switch2.setOnClickListener(new ClickEvent());
        switch1.setVisibility(View.INVISIBLE);
        switch2.setVisibility(View.INVISIBLE);
		...
		public void onClick(View v) {
			if (v == btnSend) {
                ...
                if(switch1.isChecked()){
                    mBluetoothLeService.WriteValue("200,0,0#");
                }
                else{
                    mBluetoothLeService.WriteValue("0,0,0#");
                }
            }
            else if (v == switch2){
